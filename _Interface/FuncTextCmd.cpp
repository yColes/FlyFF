...
#ifdef _AWAKE_ROLL
#ifdef __CLIENT
	if (g_WndMng.m_pWndAwakeRoll == nullptr)
	{
		g_WndMng.m_pWndAwakeRoll = new CWndAwakeRoll;
		g_WndMng.m_pWndAwakeRoll->Initialize();
	}
#endif
#else
#ifdef __WORLDSERVER
...
#ifdef _AWAKE_ROLL
		ON_TEXTCMDFUNC(TextCmd_GenRandomOption, "eveil", "gro", "각성축복", "각축", TCM_CLIENT, AUTH_GENERAL, "")
#else
