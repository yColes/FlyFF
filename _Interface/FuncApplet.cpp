...
#ifdef _MONSTER_HUNTING
DECLAREAPPLET(AppMain_MonsterHunt, new CWndMonsterHunt);
#endif
void CWndMgr::AddAllApplet()
{
#ifdef _MONSTER_HUNTING
	AddAppletFunc(AppMain_MonsterHunt, APP_CHASSEMONSTRES, _T("WndMonsterHunt"), _T("MonsterIcon.png"), "Monster hunting", 0);
#endif
