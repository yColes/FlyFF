...
//		g_DPCoreClient.SendMoverDeath( this, pAttacker, dwMsg );
	...
	if (IsValidObj(pAttacker) && pAttacker->IsPlayer() && IsNPC())
	{
#ifdef _MONSTER_HUNTING
		static_cast<CUser*>(pAttacker)->m_PlayerMonsterHunt.AddMonsterHuntToPlayer(static_cast<CUser*>(pAttacker), m_dwIndex);
#endif
	}
#endif //__WORLDSERVER	
